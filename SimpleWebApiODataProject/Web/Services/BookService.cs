...
namespace Web.Services
{
    ...
    {
        private readonly ApplicationContext _booksContext;

        public BookService(ApplicationContext booksContext)
        {
        ...
        {
            return _chapterTitles[ix].Select((title, n) => new BookChapter
            {
                Title = title,
                Book = book,
                Number = n + 1
