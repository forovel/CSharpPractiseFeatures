...
namespace SimpleCoreServer.Web.Extensions
{
    public static class SessionSample
    {
        private const string SessionVisit = nameof(SessionVisit); 
        ...
        {
            int visits = context.Session.GetInt32(SessionVisit) ?? 0;
            ...
            context.Session.SetInt32(SessionVisit, ++visits);
